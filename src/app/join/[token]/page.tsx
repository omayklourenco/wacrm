        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              Accepting adds{' '}
              <span className="text-muted-foreground">{peek.account_name}</span> to your
              organizations and switches you into it. Any organizations you
              already belong to stay intact.
            </p>
          </CardContent>
        </Card>
